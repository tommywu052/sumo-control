...
def cozmo_roll(robot: cozmo.robot.Robot):
...
def visualize_boxes_and_labels_on_image_array(
  ...
  #ctrl.send(move_cmd(0, 0))
  print (display_str)
  if 'person' in display_str: 
    print ('Stop Car')
    ctrl.send(move_cmd(0, 0))
  if 'cell phone' in display_str: 
    print ('Jump Go')
    ctrl.send(jumpCmd(1))
  if 'bottle' in display_str:
    print ('----Left Turn----')
    ctrl.send(loadCmd())
    #ctrl.send(b'\x02\x0b\x03\x0f\x00\x00\x00\x03\x02\x03\x00\x01\x00\x00\x00')
    #ctrl.send(move_cmd(10, 50))  

  #cozmoLabel=display_str            
  # if cozmoLabel:
  #   if 'cell phone' in cozmoLabel: 
  #     print ('Go')
  #     cozmo.run_program(cozmo_program)
  #   if 'cup' in cozmoLabel: 
  #     print ('Roll the Cube')
